...
namespace quic
{
    ...
    public:
        ...
        static constexpr uint64_t CubeFactor =
            1 << CubeScale / CubeCongestionWindowScale / MaxDatagramSize;
    ...
    public:
        ...
        virtual void onPacketAcked(QuicPacketNumber pn, uint64_t acked_bytes,
                                   uint64_t prior_inflight, uint64_t event_time) = 0;
        virtual void onPacketSent(uint64_t sent_time, uint64_t bytes_inflight, QuicPacketNumber pn,
                                  uint64_t bytes, bool is_retransmittable) = 0;
        virtual void onPacketLost(QuicPacketNumber pn, uint64_t lost_bytes,
                                  uint64_t prior_infligth) = 0;
    ...
    class CubicSender : public std::enable_shared_from_this<CubicSender>, public SendAlgorithm
    {
    public:
        ...
        void maybeIncreaseCwnd(QuicPacketNumber pn, uint64_t acked_bytes, uint64_t prior_inflight,
                               uint64_t event_time);
