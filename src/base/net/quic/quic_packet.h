...
namespace quic
{
    ...
    QuicEPacketHeader::ptr readPacketHeaderFrom(const MBuffer::ptr &buffer_block,
                                                size_t default_cid_len = 4);
    ...
    public:
        ...
        static int
        composeNextPacket(QuicSndStream::ptr send_stream,
                          std::deque<QuicFrame::ptr> &frames); // 从send_stream中取出frames集
        static MBuffer::ptr packPacket(PacketNumberManager::ptr pnm,
