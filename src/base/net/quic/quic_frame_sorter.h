...
namespace quic
{
    ...
    public:
        ...
        FrameSorterEntry(const MBuffer::ptr &data, const std::function<void()> &cb)
            : m_data(data), m_cb(cb)
        {
        }
    ...
    public:
        ...
        enum class Error { OK = 0, DUP_DATA = 1, TOO_MANY_GAPS = 2, UNKNOW };
    ...
    public:
        ...
        FrameSorterResult::ptr push(const MBuffer::ptr &data, QuicOffset offset,
