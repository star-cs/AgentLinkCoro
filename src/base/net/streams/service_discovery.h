...
public:
    ...
    {
        return base::GetParamValue(m_datas, key, def);
    }
...
public:
    ...
    ConsulServiceDiscovery(const std::string &name, base::ConsulClient::ptr client,
...
private:
    ...
    bool m_startRegister = false;
    base::Timer::ptr m_timer;
    base::ConsulClient::ptr m_client;
    base::ConsulRegisterInfo::ptr m_regInfo;
};
