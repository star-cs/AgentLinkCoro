...
struct ConsulCheck {
    ...
    _PACK(A("Interval", interval, "HTTP", http, "Header", header, "DeregisterCriticalServiceAfter",
...
struct ConsulRegisterInfo {
    ...
    _PACK(A("ID", id, "Name", name, "Tags", tags, "Address", address, "Meta", meta, "Port", port,
            "Check", check));
};
