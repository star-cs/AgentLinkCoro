...
public:
     ...
     */
    TcpServer(base::IOManager *worker = base::IOManager::GetThis(),
              base::IOManager *io_woker = base::IOManager::GetThis(),
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(base::Address::ptr addr, bool ssl = false);
