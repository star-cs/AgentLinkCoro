...
public:
    ...
    static std::string GetStringValue(const Json::Value &json,
                                      const std::string &default_value = "");
    static double GetDoubleValue(const Json::Value &json, double default_value = 0);
    static int32_t GetInt32Value(const Json::Value &json, int32_t default_value = 0);
    static uint32_t GetUint32Value(const Json::Value &json, uint32_t default_value = 0);
    static int64_t GetInt64Value(const Json::Value &json, int64_t default_value = 0);
    static uint64_t GetUint64Value(const Json::Value &json, uint64_t default_value = 0);
