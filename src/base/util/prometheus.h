...
struct PrometheusClientConfig {
    ...
    _PACK(O(host, port, job, username, password, labels, interval));
...
public:
    ...
    addCounter(const std::string &name, const std::string &help,
               const std::map<std::string, std::string> &labels);
    prometheus::Family<prometheus::Gauge> *
    addGauge(const std::string &name, const std::string &help,
             const std::map<std::string, std::string> &labels);
    prometheus::Family<prometheus::Histogram> *
    addHistogram(const std::string &name, const std::string &help,
                 const std::map<std::string, std::string> &labels);
    prometheus::Family<prometheus::Summary> *
    addSummary(const std::string &name, const std::string &help,
               const std::map<std::string, std::string> &labels);

    prometheus::Counter *addCounterLabels(const std::string &name,
                                          const std::map<std::string, std::string> &labels);
    prometheus::Gauge *addGaugeLabels(const std::string &name,
                                      const std::map<std::string, std::string> &labels);
    prometheus::Histogram *addHistogramLabels(const std::string &name,
                                              const std::map<std::string, std::string> &labels,
                                              const std::vector<double> &buckets);
    prometheus::Summary *addSummaryLabels(const std::string &name,
                                          const std::map<std::string, std::string> &labels,
...
private:
    ...
    std::map<std::string, std::map<std::map<std::string, std::string>, prometheus::Counter *> >
        m_counterLabels;
    std::map<std::string, std::map<std::map<std::string, std::string>, prometheus::Gauge *> >
        m_gaugeLabels;
    std::map<std::string, std::map<std::map<std::string, std::string>, prometheus::Histogram *> >
        m_histogramLabels;
    std::map<std::string, std::map<std::map<std::string, std::string>, prometheus::Summary *> >
        m_summaryLabels;
};
