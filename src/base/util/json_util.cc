...
std::string JsonUtil::GetStringValue(const Json::Value &v, const std::string &default_value)
{
    if (v.isString()) {
        return v.asString();
    } else if (v.isArray()) {
...
double JsonUtil::GetDoubleValue(const Json::Value &v, double default_value)
{
    if (v.isDouble()) {
        return v.asDouble();
    } else if (v.isString()) {
...
int32_t JsonUtil::GetInt32Value(const Json::Value &v, int32_t default_value)
{
    if (v.isInt()) {
        return v.asInt();
    } else if (v.isString()) {
...
uint32_t JsonUtil::GetUint32Value(const Json::Value &v, uint32_t default_value)
{
    if (v.isUInt()) {
        return v.asUInt();
    } else if (v.isString()) {
...
int64_t JsonUtil::GetInt64Value(const Json::Value &v, int64_t default_value)
{
    if (v.isInt64()) {
        return v.asInt64();
    } else if (v.isString()) {
...
uint64_t JsonUtil::GetUint64Value(const Json::Value &v, uint64_t default_value)
{
    if (v.isUInt64()) {
        return v.asUInt64();
    } else if (v.isString()) {
