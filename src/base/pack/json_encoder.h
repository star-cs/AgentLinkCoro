...
namespace pack
{
    ...
    {
    public:
        JsonEncoder() : m_cur(&m_value) {}

        // template<class T>
        // _NOT_PACK(T, bool) encode(const std::string& name, const T& v, const PackFlag& flag)
        // {
        //     (*m_cur)[name] = v;
        //     return true;
        // }
        ...
        // template<class T>
        // _NOT_PACK(T, bool) encode(const T& v, const PackFlag& flag) {
        //     (*m_cur) = v;
        //     return true;
        // }
...
#undef XX_ENCODE
        ...
        template <class T>
        _IS_PACK(T, bool)
        encode(const std::string &name, const T &v, const PackFlag &flag)
        {
            auto cur = m_cur;
            m_cur = &(*m_cur)[name];
            v.___encode__(*this, flag);
            m_cur = cur;
            return true;
        }
        ...
        template <class T>
        _IS_PACK(T, bool)
        encode(const T &v, const PackFlag &flag)
        {
            v.___encode__(*this, flag);
            return true;
        }
        ...
        template <class T>
        _IS_PACK(T, bool)
        encode_inherit(const T &v, const PackFlag &flag)
        {
            v.___encode__(*this, flag);
            return true;
        }
...
#define XX_ENCODE(m)                                                                               \
    template <class T, class... Args>                                                              \
    bool encode(const std::string &name, const m<std::string, T, Args...> &v,                      \
                const PackFlag &flag)                                                              \
    {                                                                                              \
        auto cur = m_cur;                                                                          \
        auto &mm = (*cur)[name];                                                                   \
...
#undef XX_ENCODE
    ...
    std::string EncodeToJsonString(const T &v, const PackFlag &flag)
    {
        ...
        return base::JsonUtil::ToString(value);
    }
