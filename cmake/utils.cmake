...
function(protobufmaker src_proto outputlist outputdir)
    ...
    add_custom_command(
        OUTPUT ${protobuf_out}
        COMMAND ${Protobuf_PROTOC_EXECUTABLE} --cpp_out=${outputdir} -I${CMAKE_CURRENT_SOURCE_DIR} ${CMAKE_CURRENT_SOURCE_DIR}/${src_proto} --experimental_allow_proto3_optional
...
function(x_add_executable targetname srcs libs)
